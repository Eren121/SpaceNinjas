...
namespace SpaceNinja
{
    ...
    public:
        ...
        template<typename T>
        sigslot::connection onEvent(BodyType a, BodyType b, EventType type, T callback);

        template<typename T>
        sigslot::connection onEvent(BodyType a, EventType type, T callback);
        ...
        void setCollisionEnabled(BodyType a, BodyType b, bool canCollide);
    ...
    private:
        ...
        struct TypePair
        {
            ...
            explicit TypePair(BodyType typeA, BodyType typeB, bool *swapped = nullptr);
        ...
        {
            explicit EventKey(BodyType typeA, BodyType typeB, EventType type, bool *swapped = nullptr)
        ...
        /// @details key.typeB should be BodyType::None.
    ...
    template<typename T>
    sigslot::connection CollisionManager::onEvent(BodyType a,
                                                  BodyType b,
                                                  ...
                                                  T callback)
    {
        ...
        const EventKey key{a, BodyType::None, type};
