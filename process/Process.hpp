...
namespace Snow::exe
{
    ...
    public:
        ...
        /// @details
        ///     Can be used internally by the process to stop normally
        ...
        /// @returns true only before end of first update() call.
    ...
    private:
        /// @brief This is set to false when the Process is stopped.
        bool m_running{true};
        ...
        /// @brief Only true before the end of the first update() call.
