...
namespace
{
    static BoolAction shoot;
    static AxisAction jump;
    static VectorAction move;
}
...
void TestInput::draw()
{
    ...
    auto header = [](const char *label, Action& action) {
    ...
    {
        static glm::vec2 value; value = move.getValue();
